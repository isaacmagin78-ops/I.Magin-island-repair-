...
export const metadata: Metadata = {
  ...
  title: {
    default: `${siteConfig.businessName} | South Florida House Cleaning & Organizing`,
    template: `%s | ${siteConfig.businessName}`,
  },
  description: siteConfig.description,
  keywords: [
    'South Florida house cleaner',
    'South Florida home organizer',
    'house cleaning South Florida',
    'home organizing South Florida',
    'condo cleaning service Florida',
    'South Florida home concierge',
    'home assistant South Florida',
  ],
  authors: [{ name: siteConfig.founderName }],
  openGraph: {
    type: 'website',
    url: siteConfig.siteUrl,
    title: `${siteConfig.businessName} | South Florida House Cleaning & Organizing`,
    description: siteConfig.description,
